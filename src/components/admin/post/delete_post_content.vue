<template>
    <div id="delete_post_modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                <button type="button"
                    ...
                    data-modal-toggle="delete_post_modal">
                ...
                <svg class="text-gray-400 dark:text-gray-500 w-11 h-11 mb-4 mx-auto" aria-hidden="true"
                ...
                <div class="flex justify-center items-center space-x-4">
                    <button data-modal-toggle="delete_post_modal" type="button"
