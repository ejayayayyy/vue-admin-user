<template>
    <!-- Add New Post Modal -->
    <div id="edit_post_modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-3xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center p-4 md:p-5 border-b rounded-t dark:border-gray-500">
                    ...
                    <div>
                        <h3 class="text-base font-semibold text-gray-900 dark:text-white">MDRRMO
                            <span class="text-gray-500 text-sm font-normal">(Edit)</span>
                        </h3>
                    </div>

                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-hide="edit_post_modal">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form @submit.prevent="submitForm">
                        <div class="flex flex-col space-y-1">
                            <!-- title -->
                            <input type="text" id="title" v-model="post.editTitle"
                            ...
                            <!-- content -->
                            <!-- <textarea id="content" v-model="post.editContent"
                            ...
                            <div
                                ...
                                <div style="height: 100%; width: 100%;" class="">
                                    <quill-editor :key="editorKey" v-model="post.editContent" ref="quillEditor" class="z-10 " 
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <div class="flex space-x-1">
                                    <!-- add photo -->
                                    <input type="file" id="photo-upload" @change="handleEditPhotoUpload" multiple
                                        accept="image/*" class="hidden" ref="photoInput">
                                    <button type="button" @click="triggerEditPhotoUpload"
                        ...
                        <div v-if="isLightboxOpen"
                            ...
                            <div class="relative w-full max-w-4xl">
                                <img :src="post.photos[lightboxIndex].previewUrl"
...
export default {
    ...
    methods: {
        ...
        // Open lightbox at a specific index (for navigation through photos)
        openLightbox(index) {
            this.lightboxIndex = index;
            this.isLightboxOpen = true;
        },
        nextPhoto() {
            if (this.lightboxIndex < this.post.photos.length - 1) {
                this.lightboxIndex++;
            } else {
        ...
        prevPhoto() {
            if (this.lightboxIndex > 0) {
                ...
                this.lightboxIndex = this.post.photos.length - 1;
            }
        },
        // Close the lightbox
        closeLightbox() {
