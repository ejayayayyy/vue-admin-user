<template>
    <div class="hidden xl:flex flex-col w-1/2">
        <div class="text-2xl font-semibold mb-4 ">
            Notifications
        </div>

        <div
            class="bg-white dark:bg-gray-700 rounded flex flex-col dark:text-gray-300 text-base shadow h-auto overflow-hidden border border-gray-300 dark:border-gray-500">
            <div class="">
                <a href="#"
