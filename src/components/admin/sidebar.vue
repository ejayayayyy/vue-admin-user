<template>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="/admin/dashboard" class="flex ms-2 md:me-24">
                        <img src="../../../public/img/naujan-lgu-logo.png" class="h-8 me-3" alt="Logo" />
                        <span
                            class="self-center text-xl hidden md:flex font-bold lg:text-2xl whitespace-nowrap dark:text-white">Flood
                            Watch</span>
                    </a>
                </div>
                ...
                <div class="flex space-x-2">
                    ...
                    <!-- Dropdown menu -->
                    <div class="hidden overflow-hidden z-40 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                        id="notification-dropdown">
                        <div
                            class="block py-4 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Notifications
                        </div>
                        <div>
                            <a href="#"
                                ...
                                <div class="pl-3 w-full">
                                    ...
                                    <div class="text-xs font-medium text-blue-700 dark:text-blue-400">a few
                                        moments ago</div>
                                </div>
                            </a>
                            <a href="#"
                                ...
                                <div class="pl-3 w-full">
                                    ...
                                    <div class="text-xs font-medium text-blue-700 dark:text-blue-400">10 minutes
                                        ago</div>
                                </div>
                            </a>
                            <a href="#"
                                ...
                                <div class="pl-3 w-full">
                                    ...
                                    <div class="text-xs font-medium text-blue-700 dark:text-blue-400">44 minutes
                                        ago</div>
                                </div>
                            </a>
                            <a href="#"
                                ...
                                <div class="pl-3 w-full">
                                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400"><span
                                        ...
                                        mentioned you in a comment: <span
                                            class="font-medium text-blue-700 dark:text-blue-500">@bonnie.green</span>
                                        what do you say?</div>
                                    <div class="text-xs font-medium text-blue-700 dark:text-blue-400">1 hour ago
                                    </div>
                                </div>
                            </a>
                            <a href="#" class="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <div class="pl-3 w-full">
                                    ...
                                    <div class="text-xs font-medium text-blue-700 dark:text-blue-400">3 hours ago
                                    </div>
                                </div>
                            </a>
                        </div>
                        <a href="#"
                            class="block py-4 text-base font-medium text-center text-gray-900 bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700 dark:text-white dark:hover:underline">
                    ...
                    <!-- dropdown (apps) -->
                    <div class="hidden overflow-hidden z-40 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                        id="apps-dropdown">
                        <div
                            class="block py-4 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Apps
                        ...
                        <div class="flex items-center ms-3">
                            <div>
                                <button type="button"
                                    ...
                                    <img class="w-8 h-8 rounded-full" src="../../../public/img/mdrrmo.png"
                                        alt="user photo">
                                </button>
                            </div>
    ...
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 md:pt-24 transition-transform -translate-x-full bg-white border-r border-gray-200 lg:translate-x-0 dark:bg-gray-900 dark:border-gray-700"
        aria-label="Sidebar">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Weather</span>
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/admin/forecast"
                                class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Forecast</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Tall
                                Bridge</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">History</a>
                        </li>
                    </ul>
                </li>
                <!-- reports -->
